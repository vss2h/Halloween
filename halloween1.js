...
{         
        ...
        for(var i=0; i<40; i++)
        {
                ...
                modelViewMatrix=mult(modelViewMatrix, scale4(1/8,1/8, 1));
                gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
...
{
       modelViewMatrix=mat4();
       modelViewMatrix = mult(modelViewMatrix, translate(0,-5.2, 1));
       ...
       gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
        ...
        {
                modelViewMatrix=mat4();
                modelViewMatrix = mult(modelViewMatrix, translate(0,-7+(i/6), 1));
                modelViewMatrix=mult(modelViewMatrix, scale4(0.2,0.2, 1));
                gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix));
                gl.drawArrays( gl.LINE_STRIP, 213,2);
                gl.drawArrays( gl.LINE_STRIP, 215,2);
...
{ 
        ...
        gl.drawArrays( gl.LINE_STRIP, 228,39);


        gl.drawArrays( gl.LINE_STRIP, 267,2);
        gl.drawArrays( gl.LINE_STRIP, 269,2);
        gl.drawArrays( gl.LINE_STRIP, 271,2);
        gl.drawArrays( gl.LINE_STRIP, 273,2);

        modelViewMatrix=mat4();
        modelViewMatrix = mult(modelViewMatrix, translate(1.9,-5.3, 1));
        gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix)); 
        gl.drawArrays( gl.LINE_STRIP, 267,2);

        modelViewMatrix=mat4();
        modelViewMatrix = mult(modelViewMatrix, translate(2.9,-5.3, 1));
        gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(modelViewMatrix)); 
        gl.drawArrays( gl.LINE_STRIP, 269,2);
...
function render() 
{
       ...
       // then, draw ghost
       modelViewMatrix = mat4();
       modelViewMatrix = mult(modelViewMatrix, translate(-6, -1, 0));
